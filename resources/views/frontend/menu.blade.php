                    ...
                    <div class="col-md-4 col-xl-3" data-cue="slideInUp">
                        <div class="item menu_item_grid">
                            ...
                            @guest
                                    ...
                                    @else
                                    <a class="btn_1" href="{{ route('cart.add', [$item->id, auth()->user()->id]) }}">+</a>
                                    @endguest
                        </div>
                    </div>
                    @endforeach
...
{{--                <p>Cum doctus civibus efficiantur in imperdiet</p>--}}
        ...
        <div class="banner lazy">
            <p class="text-center"><a href="#0" class="btn_1 outline">به اشتراک‌گذاری منو</a></p>
        </div>
    </div>
@endsection
