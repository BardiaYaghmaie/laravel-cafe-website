                                ...
                                <div class="col-lg-6 m-auto static">
                                    <div class="slide-text white text-center">
                                        ...
                                        <div class="owl-slide-animated owl-slide-cta"><a class="btn_1 btn_scroll"
                                                href="{{ route('menu') }}" role="button">به منوی ما سر بزن</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="pattern_2">
        <div class="container margin_120_100 home_intro">
            <div class="row justify-content-center d-flex align-items-center">
                ...
                <div class="col-lg-5 pt-lg-4" data-cue="slideInUp" data-delay="500" style="direction: rtl">
                    <div class="main_title" style="direction: rtl">
                        <span><em></em></span>
                        <h2>درباره ما</h2>
        ...
        <div class="row">
            <div class="col-xl-4">
                <a href="{{ route('menu') }}" class="img_container">
                    ...
                    <div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)" style="direction: rtl">
                        <h3>منو</h3>
                        <p>نتیجه ۲۰ سال طبخ غذای معرکه</p>
                    </div>
                </a>
            </div>
            <div class="col-xl-4">
                <a href="menu.html" class="img_container">
                    ...
                    <div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)" style="direction: rtl">
                        <h3>بلاگ</h3>
                        <p>درباره آنچه می‌خورید، بیش‌تر بدانید</p>
                    </div>
                </a>
            </div>
            <div class="col-xl-4">
            ...
            <div class="col-xl-4">
                <a href="menu.html" class="img_container">
                    ...
                    <div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)" style="direction: rtl">
                        <h3>رزرو میز</h3>
                        <p>به ما بگویید کی انتظار شما را بکشیم</p>
                    </div>
                </a>
            </div>
            <div class="col-xl-4">
...
{{--                                    <p>Raspberries, Blackberries</p>--}}
                                    @guest
                                    <a href="javascript:void(0)" class="btn_1" data-bs-toggle="modal" data-bs-target="#exampleModal">+</a>
                                    @else
                                    <a class="btn_1" href="{{ route('cart.add', [$menu->id, auth()->user()->id]) }}">+</a>
                                    @endguest
                                </div>
                            </div>
                            @endforeach
                ...
                <div class="col-xl-4">
                    <div class="banner lazy" data-bg="url({{ asset('assets/frontend/img/banner_bg.jpg') }})">
                        <div class="wrapper opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                            <div class="text">
                                <small>رزرواسیون میز</small>
{{--                                <p>Hamburgher, Chips, Mix Sausages, Beer, Muffin</p>--}}
                                <a href="reservations.html" class="btn_1">حالا رزرو کنید</a>
                            </div>
            ...
            <p class="text-center"><a href="#0" class="btn_1 outline" data-cue="zoomIn">به اشتراک‌گذاری منو</a></p>
        </div>
    </div>
...
{{--                            <h2><span>a Special Event with us!</span></h2>--}}
...
{{--        </div>--}}
    ...
    <div class="pattern_2 pattern_calendar" style="direction: rtl">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12" data-cue="slideInUp">
                    <div class="main_title">
                        <span><em></em></span>
                        <h2>رزرو میز</h2>
                        <p>یا با شماره {{$general ? $general->primary_phone:''}} تماس بگیرید</p>
                    </div>
                    <div id="wizard_container">
                        <form action="{{ route('reserve') }}" method="POST">
                            ...
                            <div id="middle-wizard">
                                <div class="step">
                                    <h3 class="main_question"><strong>1/3</strong>انتخاب تاریخ</h3>
                                ...
                                <!-- /step-->
                                <div class="step">
                                    <h3 class="main_question"><strong>2/3</strong>انتخاب زمان و تعداد نفرات</h3>
                                ...
                                <div class="submit step">
                                    <h3 class="main_question"><strong>3/3</strong>لطفا اینجارو پر کنید
                                    </h3>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="email" name="email"
                                                       class="form-control required" placeholder="ahmad.pm@iust.ac.ir">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="text" name="phone"
                                                       class="form-control required" placeholder="09345678676">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                            <textarea class="form-control" name="description"
                                                      placeholder="صحبت دیگه‌ای؟"></textarea>
                                    </div>
